  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "60px 20px 0" }}>
        <Link href={`/lista/${id}/pagamento?nome=${encodeURIComponent(contributor)}`}>
          <BackButton />
        </Link>
      </div>
      ...
      <div style={{ padding: "28px 24px 0", flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ marginTop: 18, padding: "14px 16px", borderRadius: 12, background: `${P.accent}0C`, border: `1px solid ${P.accent}20` }}>
          <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
            ...
            <p style={{ fontFamily: FONTS.body, fontSize: 12.5, color: P.inkSoft, margin: 0, lineHeight: 1.6 }}>
              Abra o app do seu banco, selecione <strong style={{ color: P.ink }}>PIX → Pagar</strong>, cole a chave e confirme o valor de <strong style={{ color: P.ink }}>R$ {gift.price}</strong>.
            </p>
          </div>
        </div>
        ...
        <div style={{ paddingBottom: 32, display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <Link
            href={`/lista/${id}/pagamento?nome=${encodeURIComponent(contributor)}`}
            style={{ textDecoration: "none" }}
          >
            <div style={{
              height: 46,
